...
abstract class AppBindModule {
    ...
    @Binds
    @Singleton
    abstract fun bindReviewModeRepository(impl: ReviewModeRepositoryImpl): ReviewModeRepository

    @Binds
    @Singleton
    abstract fun bindSakeImageRepository(impl: SakeImageRepositoryImpl): SakeImageRepository
